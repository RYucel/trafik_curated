...
**Tarih**: 2026-08-15  
**Güvenlik Sınıfı**: `REVIEW_REQUIRED` (3 incidents remain unverified and require reviewer confirmation before public release.)  
...
- **2026 YTD (Ocak–Temmuz)**: 27 Can Kaybı
- **2025 Aynı Dönem (Ocak–Temmuz)**: 2 Can Kaybı (Değişim: +1250%)
- **2024 Aynı Dönem (Ocak–Temmuz)**: 23 Can Kaybı (Değişim: +17.4%)
